...
def main():
    ...
    best_model_path = f"{checkpoint_dir}/dino_best_model.pth"
    pr_curve_path = f"{prediction_dir}/dino_pr_curve.png"
    loss_curve_path = f"{prediction_dir}/dino_loss_curve.png"
    ...
    # Datasets
    train_dataset = ECSSDDataset(train_pairs, image_size=IMAGE_SIZE, normalize_mean=DINO_MEAN, normalize_std=DINO_STD)
    val_dataset = ECSSDDataset(val_pairs, image_size=IMAGE_SIZE, normalize_mean=DINO_MEAN, normalize_std=DINO_STD)
    test_dataset = ECSSDDataset(test_pairs, image_size=IMAGE_SIZE, normalize_mean=DINO_MEAN, normalize_std=DINO_STD)
